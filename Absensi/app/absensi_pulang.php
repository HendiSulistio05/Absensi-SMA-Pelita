...
<body>
    ...
    <div class="main">
        <div class="row">
            <a href="absensi_pulang" class="column" style="background-color: red;">Refresh</a>
            ...
            <!-- <a href="absensi_all" class="column" style="background-color: #de6202;">Absensi Masuk</a> -->
        ...
        <div class="box">
            ...
            <table class="text">
                ...
                <tbody>
                    <?php
						$s_absen = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM absen WHERE tanggal = CURDATE() AND ijin IS NULL AND masuk IS NOT NULL AND pulang IS NOT NULL order by pulang DESC");
                            ...
                            ?>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <a href="edit_absen?id=<?= $d_absen['card_id'];?>" >Edit</a></li>
                                    </div>
                                </div>
                                <?php
                                }?>
